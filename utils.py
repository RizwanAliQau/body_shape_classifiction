...
def add_text(image, text='',pos=(10,10),color = (0, 0, 255)):
    # font 
...
def result_to_condition(class_id,annotated_frame):
    if class_id==0:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: Fitted or Structured Tops, Bright Color Tops, V-necks, Jackets, Dark Colored Pants, Necklaces, Earrings *****',pos=(50,50))
    elif class_id==1:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: shapeless clothing, smock dresses, turtle-necks, drop waist *****',pos=(50,50)) 
    elif class_id==2:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: boat necks, V-necks, heavy shoulder pads, skinny trousers *****',pos=(50,50)) 
    elif class_id==3:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: Structured tailoring, prints, patterns, scoop necklines *****',pos=(50,50)) 
    elif class_id==4:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: horizontal patterns, stripes, tight clothing *****',pos=(50,50)) 
    elif class_id==5:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: Tight tops, hip-length&lowrise jackets, skinny jeans, leggings *****',pos=(50,50)) 
    elif class_id==6:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: shapeless and boxy styles, pea coats, baggy jeans *****',pos=(50,50)) 
    elif class_id==7:
        annotated_frame =   add_text(annotated_frame,'***** Clothes Recommendations: Horizontal stripes, Structurec *****',color = (0, 255, 0))
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: Double-Breasted Jackets *****',pos=(50,50))
    elif class_id==8:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: Loose and saggy clothing, bland clothing *****',pos=(50,50)) 
    elif class_id==9:
        ...
        annotated_frame =   add_text(annotated_frame, text='***** Clothes to Avoid: Fitted polo shirts, Roll necks, Oversized clothing, Skinny fits *****',pos=(50,50)) 
